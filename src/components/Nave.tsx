  ...
  return (
    <div>
      <div
        ...
        className=" md:hidden bg-[#343a40;] px-3 py-2 w-full text-2xl text-white  justify-between flex items-center fixed h-16 z-50 "
      >
        {!show && <h1 className="text-2xl font-bold font-sans ">RESU<span className="text-[#ffc107;] ">ME</span></h1>}
